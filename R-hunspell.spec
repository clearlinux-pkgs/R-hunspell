...
Version  : 3.0.4
Release  : 54
URL      : https://cran.r-project.org/src/contrib/hunspell_3.0.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/hunspell_3.0.4.tar.gz
...
%setup -q -n hunspell
pushd ..
cp -a hunspell buildavx2
popd
pushd ..
cp -a hunspell buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724075017
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/hunspell/libs/hunspell.so
/V4/usr/lib64/R/library/hunspell/libs/hunspell.so
